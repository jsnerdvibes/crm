    ...
    constructor(service) {
        ...
        this.register = async (req, res, next) => {
            try {
                ...
                return res
                    .status(201)
                    .json((0, response_1.successResponse)('Tenant and Admin created successfully', result));
            }
            catch (error) {
                next(error);
            }
        ...
        this.login = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Login successful', result));
            }
            catch (err) {
                next(err);
            }
        ...
        this.logout = async (req, res) => {
            try {
                logger_1.logger.info('Request in controller');
                const { refreshToken } = req.body;
                logger_1.logger.info('Token Extracted from request');
                await this.service.logout(refreshToken);
                return res
                    .status(200)
                    .json((0, response_1.successResponse)('Logged out successfully', {}));
            }
            catch (err) {
                return res
                    .status(500)
