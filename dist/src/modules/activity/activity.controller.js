    ...
    constructor(service) {
        ...
        this.create = async (req, res, next) => {
            try {
                ...
                const result = await this.service.createActivity(tenantId, actorId, req.body, performedById);
                return res
                    .status(201)
                    .json((0, response_1.successResponse)('Activity created successfully', result));
            }
            catch (error) {
                next(error);
            }
        ...
        this.findById = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Activity retrieved successfully', activity));
            }
            catch (error) {
                next(error);
            }
        ...
        this.update = async (req, res, next) => {
            try {
                ...
                if (!tenantId)
                    throw new error_1.ForbiddenError('You are not authorized');
                const updated = await this.service.updateActivity(tenantId, activityId, req.body, performedById);
                return res.json((0, response_1.successResponse)('Activity updated successfully', updated));
            }
            catch (error) {
                next(error);
            }
        ...
        this.delete = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Activity deleted successfully', {}));
            }
            catch (error) {
                next(error);
            }
        ...
        this.findAll = async (req, res, next) => {
            try {
                ...
                const rawTargetType = (0, query_1.getQueryString)(req.query.targetType);
                const filters = {
                    page,
                    limit,
                    targetType: (0, types_1.isTargetType)(rawTargetType) ? rawTargetType : undefined,
                    targetId: (0, query_1.getQueryString)(req.query.targetId),
                    completed: (0, query_1.getQueryBoolean)(req.query.completed),
                };
