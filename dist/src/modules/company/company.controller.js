    ...
    constructor(service) {
        ...
        this.create = async (req, res, next) => {
            try {
                ...
                return res
                    .status(201)
                    .json((0, response_1.successResponse)('Company created successfully', result));
            }
            catch (error) {
                next(error);
            }
        ...
        this.update = async (req, res, next) => {
            try {
                ...
                const performedById = req.user?.id;
                const updated = await this.service.updateCompany(tenantId, companyId, req.body, performedById);
                return res.json((0, response_1.successResponse)('Company updated successfully', updated));
            }
            catch (error) {
                next(error);
            }
        ...
        this.delete = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Company deleted successfully'));
            }
            catch (error) {
                next(error);
            }
        ...
        this.getById = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Company fetched successfully', company));
            }
            catch (error) {
                next(error);
            }
        ...
        this.getAll = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Companies fetched successfully', companies));
            }
            catch (error) {
                next(error);
            }
