    ...
    constructor(service) {
        ...
        this.create = async (req, res, next) => {
            try {
                ...
                return res
                    .status(201)
                    .json((0, response_1.successResponse)('User created successfully', result));
            }
            catch (error) {
                next(error);
            }
        ...
        this.findById = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('User retrieved successfully', user));
            }
            catch (error) {
                next(error);
            }
        ...
        this.findAll = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Users fetched successfully', { users }));
            }
            catch (error) {
                next(error);
            }
        ...
        this.update = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('User updated successfully', updated));
            }
            catch (error) {
                next(error);
            }
        ...
        this.deactivate = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('User deactivated successfully', updated));
            }
            catch (error) {
                next(error);
            }
        ...
        this.delete = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('User deleted permanently', {}));
            }
            catch (error) {
                next(error);
            }
