...
class SettingController {
    constructor(service) {
        ...
        this.getAll = async (req, res) => {
            ...
            return res.json((0, response_1.successResponse)('Settings fetched', settings));
        };
        /**
         * @swagger
         * /api/v1/settings/{key}:
        ...
        this.update = async (req, res) => {
            ...
            return res.json((0, response_1.successResponse)('Setting updated', setting));
        };
    }
    getTenantId(req) {
        const tenantId = req.user?.tenantId;
        if (!tenantId) {
            throw new error_1.ForbiddenError('Tenant cannot be undefined');
        }
        return tenantId;
    }
}
