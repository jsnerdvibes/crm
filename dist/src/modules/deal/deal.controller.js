...
class DealsController {
    constructor(service) {
        ...
        this.create = async (req, res, next) => {
            try {
                ...
                return res
                    .status(201)
                    .json((0, response_1.successResponse)('Deal created successfully', result));
            }
            catch (error) {
                next(error);
            }
        ...
        this.findById = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Deal retrieved successfully', deal));
            }
            catch (error) {
                next(error);
            }
        ...
        this.update = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Deal updated successfully', updated));
            }
            catch (error) {
                next(error);
            }
        ...
        this.delete = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Deal deleted successfully', {}));
            }
            catch (error) {
                next(error);
            }
         ...
         *                   example: []
         */
        this.assignDeal = async (req, res, next) => {
            try {
                const tenantId = req.user.tenantId;
                const dealId = req.params.id;
                const { assignedToId } = req.body;
                const performedById = req.user?.id;
                const updated = await this.service.assignDeal(tenantId, dealId, assignedToId, performedById);
                return res.json((0, response_1.successResponse)('Deal assigned successfully', updated));
            }
            catch (error) {
                next(error);
            }
         ...
         *                   example: []
         */
        this.updateStage = async (req, res, next) => {
            try {
                const tenantId = req.user.tenantId;
                const dealId = req.params.id;
                const { stage } = req.body;
                const performedById = req.user?.id;
                const updated = await this.service.updateDealStage(tenantId, dealId, stage, performedById);
                return res.json((0, response_1.successResponse)('Deal stage updated successfully', updated));
            }
            catch (error) {
                next(error);
            }
        ...
        this.findAll = async (req, res, next) => {
            try {
                const tenantId = req.user?.tenantId;
                if (!tenantId) {
                    throw new error_1.ForbiddenError('You are not authorized');
                }
                ...
                const filters = {
                    ...
                    assignedToId: (0, query_1.getQueryString)(req.query.assignedToId),
                    companyId: (0, query_1.getQueryString)(req.query.companyId),
                    search: (0, query_1.getQueryString)(req.query.search),
                };
    ...
    isDealStage(value) {
        return (typeof value === 'string' &&
            Object.values(db_1.DealStage).includes(value));
    }
}
