    ...
    constructor(service) {
        ...
        this.create = async (req, res, next) => {
            try {
                ...
                return res
                    .status(201)
                    .json((0, response_1.successResponse)('Contact created successfully', contact));
            }
            catch (error) {
                next(error);
            }
        ...
        this.getAll = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Contacts retrieved', contacts));
            }
            catch (error) {
                next(error);
            }
        ...
        this.getById = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Contact retrieved', contact));
            }
            catch (error) {
                next(error);
            }
        ...
        this.update = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Contact updated successfully', updated));
            }
            catch (error) {
                next(error);
            }
        ...
        this.delete = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Contact deleted successfully'));
            }
            catch (error) {
                next(error);
            }
