    ...
    constructor(service) {
        ...
        this.create = async (req, res, next) => {
            try {
                ...
                return res
                    .status(201)
                    .json((0, response_1.successResponse)('Lead created successfully', result));
            }
            catch (error) {
                next(error);
            }
        ...
        this.findById = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Lead retrieved successfully', lead));
            }
            catch (error) {
                next(error);
            }
        ...
        this.update = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Lead updated successfully', updatedLead));
            }
            catch (error) {
                next(error);
            }
        ...
        this.delete = async (req, res, next) => {
            try {
                ...
                return res.json((0, response_1.successResponse)('Lead deleted successfully', {}));
            }
            catch (error) {
                next(error);
            }
         ...
         *                   example: []
         */
        this.assignLead = async (req, res, next) => {
            try {
                const tenantId = req.user.tenantId;
                const leadId = req.params.id;
                const performerId = req.user?.id;
                ...
                return res.json((0, response_1.successResponse)('Lead assigned successfully', result));
            }
            catch (error) {
                next(error);
            }
        ...
        this.findAll = async (req, res, next) => {
            try {
                ...
                let status;
                if (typeof rawStatus === 'string' && (0, dto_1.isLeadStatus)(rawStatus)) {
                ...
                const filters = {
                    ...
                    limit,
                    status, // type guard
                    source: (0, query_1.getQueryString)(req.query.source),
