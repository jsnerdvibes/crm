...
export class DealsController {
  ...
  create = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      ...
      const result = await this.service.createDeal(
        tenantId,
        req.body,
        performedById
      );
  ...
  update = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      ...
      const updated = await this.service.updateDeal(
        tenantId,
        dealId,
        req.body,
        performedById
  ...
  assignDeal = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
      ...
      return res.json(successResponse('Deal assigned successfully', updated));
    } catch (error) {
      next(error);
    }
  };
